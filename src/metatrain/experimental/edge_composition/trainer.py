...
from .model import EdgeCompositionModel
from .utils.transforms import get_coupling_transform, get_radial_training_transform
...
class Trainer(TrainerInterface):
    ...
    def train(
        ...
        assert dtype in EdgeCompositionModel.__supported_dtypes__
        ...
        collate_fn = CollateFn(
            ...
            callables=[
                ...
                *(
                    [get_coupling_transform(model.max_l)]
                    if model.hypers["sph_basis"] == "coupled"
                    else []
                ),
                get_radial_training_transform(
                    requested_neighbor_lists[0],
                    model,
                    missing_values=self.hypers["missing_values"],
                ),
            ],
